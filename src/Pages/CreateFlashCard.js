                    ...
                    {cards && cards.length > 0
                      ? cards.map((card, index) => (
                          ...
                          >
                            ...
                            <div className='flex  md:space-x-10 md:flex-row '>
                              <div className="relative flex flex-col  space-y-3 align-middle justify-center">
                                ...
                                <Field
                                  ...
                                  name={`cards.${index}.cardname`}
                                  innerRef={editRef}
                                  className="border-slate-400 md:w-64 border-2 rounded-sm focus:fing-slate-400 focus:border focus:border-slate-400 h-12"
                                />{" "}
                                {/* <span className="absolute left-[5.8rem] -top-[15px] md:top-0 text-lg font-medium">
                                  {" "}
                                  *{" "}
                              ...
                              <div className="relative flex flex-col justify-center space-y-4 align-middle">
                                ...
                                <Field
                                  as="textarea"
                                  name={`cards.${index}.carddescription`}
                                  className="resize-none lg:w-72 border-slate-400 md:w-64 border-2 rounded-sm focus:fing-slate-400 focus:border focus:border-slate-400 h-12  "
                                />{" "}
                                {/* <span className="absolute left-[8.5rem] -top-[1rem] text-lg font-medium">
                                  *
                                </span> */}
