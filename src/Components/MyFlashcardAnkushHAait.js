   ...
   <div>
        <div class="container mt-10 mx-auto ">
          ...
          <p class="px-2">
            ...
            illum, voluptate qui eligendi voluptas facilis totam nemo!Quam eos
            atque recusandae? Perspiciatis consequuntur dolores odio sunt
            provident obcaecati odit!
          </p>
          <div className="p-5 bg-slate-300 m-6 mx-1.5 my-1.5">
            <div class="flex items-start justify-center ">
              <div class="px-3 py-2 m-5 h-auto w-60 space-y-6 bg-slate-100">
              ...
              <div class="p-2 m-5 h-auto w-2/3 bg-slate-100">
                <p>
              ...
              <div class="p-2 m-5 h-auto w-52 bg-slate-100">block 3-</div>
            </div>
          </div>
        </div>
      </div>
