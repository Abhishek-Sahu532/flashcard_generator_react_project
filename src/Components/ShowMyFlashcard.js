...
const ShowMyFlashcard = () => {
  ...
  useEffect(() => {
    ...
    cardValueArrindex = cardValueArr[0]; //to store localstorage array
    // console.log(cardValueArr)
    // console.log(cardValueArrindex)

    cardValueArrindex.forEach((element, index) => {
  ...
  return (
    ...
    <div className="mx-10 my-10 grid grid-cols-3 gap-4 place-content-around flex flex-wrap justify-items-center">
      {cardValueArrindex.forEach((element) => {
